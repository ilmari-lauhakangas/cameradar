...
import (
	...
	"github.com/ilmari-lauhakangas/cameradar/v5"
...
func parseArguments() error {
	...
	pflag.StringP("custom-routes", "r", "${GOPATH}/src/github.com/ilmari-lauhakangas/cameradar/dictionaries/routes", "The path on which to load a custom routes dictionary")
	pflag.StringP("custom-credentials", "c", "${GOPATH}/src/github.com/ilmari-lauhakangas/cameradar/dictionaries/credentials.json", "The path on which to load a custom credentials JSON dictionary")
